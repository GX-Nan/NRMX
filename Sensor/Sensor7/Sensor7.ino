...
const IPAddress serverIP(192, 168, 31, 246); //欲访问的地址
...
void loop() {
  ...
  String log;
  unsigned long CO2;
  int PM2_5, PM10, temp_1, PM1_0, rhum_1;
  float cTemp, hum ;
  uint16_t eco2;
  uint16_t stat;
  uint32_t resist;
  uint16_t etvoc;
  String myCO2, myPM1_0, myPM2_5, myPM10, mytemp, myT,myrhum;
  ...
  if (client.connect(serverIP, serverPort)) //尝试访问目标地址
  {
    ...
    while (client.connected() || client.available()) //如果已连接或有收到的未读取的数据
    {
      ...
      if (0 <= CO2 && CO2 < 10)
      {
        myCO2 = String("ESPB02") + String("000") + String(CO2);
        client.print(myCO2);
      }
      else if (10 <= CO2 && CO2 < 100)
      {
        myCO2 = String("ESPB02") + String("00") + String(CO2);
        client.print(myCO2);
      }
      else if (100 <= CO2 && CO2 < 1000)
      {
        myCO2 = String("ESPB02") + String("0") + String(CO2);
        client.print(myCO2);
      }
      else if (1000 <= CO2 && CO2 < 10000)
      {
        myCO2 = String("ESPB02") + String(CO2);
        client.print(myCO2);
      }
      delay(300);
      pms.requestRead();
      if (pms.readUntil(data))
      {
        ...
        if (0 <= PM1_0 && PM1_0 < 10)
        {
          myPM1_0 = String("ESPB03") + String("000") + String(PM1_0);
          client.print(myPM1_0);
        }
        else if (10 <= PM1_0 && PM1_0 < 100)
        {
          myPM1_0 = String("ESPB03") + String("00") + String(PM1_0);
          client.print(myPM1_0);
        }
        else if (100 <= PM1_0 && PM1_0 < 1000)
        {
          myPM1_0 = String("ESPB03") + String("0") + String(PM1_0);
          client.print(myPM1_0);
        }
        else if (1000 <= PM1_0 && PM1_0 < 10000)
        {
          myPM1_0 = String("ESPB03") + String(PM1_0);
          client.print(myPM1_0);
        }
        delay(300);
        //---------------------------------------------
        ...
        if (0 <= PM2_5 && PM2_5 < 10)
        {
          myPM2_5 = String("ESPB04") + String("000") + String(PM2_5);
          client.print(myPM2_5);
        }
        else if (10 <= PM2_5 && PM2_5 < 100)
        {
          myPM2_5 = String("ESPB04") + String("00") + String(PM2_5);
          client.print(myPM2_5);
        }
        else if (100 <= PM2_5 && PM2_5 < 1000)
        {
          myPM2_5 = String("ESPB04") + String("0") + String(PM2_5);
          client.print(myPM2_5);
        }
        else if (1000 <= PM2_5 && PM2_5 < 10000)
        {
          myPM2_5 = String("ESPB04") + String(PM2_5);
          client.print(myPM2_5);
        }
        delay(300);
        //-----------------------------------------------
        ...
        if (0 <= PM10 && PM10 < 10)
        {
          myPM10 = String("ESPB05") + String("000") + String(PM10);
          client.print(myPM10);
        }
        else if (10 <= PM10 && PM10 < 100)
        {
          myPM10 = String("ESPB05") + String("00") + String(PM10);
          client.print(myPM10);
        }
        else if (100 <= PM10 && PM10 < 1000)
        {
          myPM10 = String("ESPB05") + String("0") + String(PM10);
          client.print(myPM10);
        }
        else if (1000 <= PM10 && PM10 < 10000)
        {
          myPM10 = String("ESPB05") + String(PM10);
          client.print(myPM10);
        }
        delay(300);
      }
      ...
      Wire.flush();
      cTemp = ((((data2[0] * 256.0) + data2[1]) * 175) / 65535.0) - 45;
      hum = ((((data2[3] * 256.0) + data2[4]) * 100) / 65535.0);
      ...
      {
        mytemp = String("ESPB07") + String("000") + String(temp_1);
        client.print(mytemp);
      }
      else if (10 <= temp_1 && temp_1 < 100)
      {
        mytemp = String("ESPB07") + String("00") + String(temp_1);
        client.print(mytemp);
      }
      else if (100 <= temp_1 && temp_1 < 1000)
      {
        mytemp = String("ESPB07") + String("0") + String(temp_1);
        client.print(mytemp);
      }
      else if (1000 <= temp_1 && temp_1 < 10000)
      {
        mytemp = String("ESPB07") + String(temp_1);
        client.print(mytemp);
      }
      delay(300);
      //--------------------------------------------------------------
      ...
      {
        myrhum = String("ESPB08") + String("000") + String(rhum_1);
        client.print(myrhum);
      }
      else if (10 <= rhum_1 && rhum_1 < 100)
      {
        myrhum = String("ESPB08") + String("00") + String(rhum_1);
        client.print(myrhum);
      }
      else if (100 <= rhum_1 && rhum_1 < 1000)
      {
        myrhum = String("ESPB08") + String("0") + String(rhum_1);
        client.print(myrhum);
      }
      else if (1000 <= rhum_1 && rhum_1 < 10000)
      {
        myrhum = String("ESPB08") + String(rhum_1);
        client.print(myrhum);
      }
      delay(300);
      ...
      if (0 <= etvoc && etvoc < 10)
      {
        myT = String("ESPB09") + String("000") + String(etvoc);
        client.print(myT);
      }
      else if (10 <= etvoc && etvoc < 100)
      {
        myT = String("ESPB09") + String("00") + String(etvoc);
        client.print(myT);
      }
      else if (100 <= etvoc && etvoc < 1000)
      {
        myT = String("ESPB09") + String("0") + String(etvoc);
        client.print(myT);
      }
      else if (1000 <= etvoc && etvoc < 10000)
      {
        myT = String("ESPB09") + String(etvoc);
        client.print(myT);
      }
      delay(1000);
      Serial.flush();
