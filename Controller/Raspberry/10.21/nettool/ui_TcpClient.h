...
public:
    ...
    void setupUi(QDialog *UiIPSreach)
    {
        ...
        pushButton_2 = new QPushButton(UiIPSreach);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(80, 480, 75, 23));
    ...
    void retranslateUi(QDialog *UiIPSreach)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("UiIPSreach", "PushButton", nullptr));
    } // retranslateUi
