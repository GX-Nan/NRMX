...
" border-style: solid;"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/new/Air/Air/Low_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon1.addFile(QStringLiteral(":/new/Air/Air/Low_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon1.addFile(QStringLiteral(":/new/Air/Air/Low_OFF.png"), QSize(), QIcon::Disabled, QIcon::On);
        icon1.addFile(QStringLiteral(":/new/Air/Air/Low_ON.png"), QSize(), QIcon::Active, QIcon::On);
        Fan_Low->setIcon(icon1);
...
" border-style: solid;"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/new/Air/Air/Mid_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon2.addFile(QStringLiteral(":/new/Air/Air/Mid_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon2.addFile(QStringLiteral(":/new/Air/Air/Mid_ON.png"), QSize(), QIcon::Active, QIcon::On);
        Fan_Mid->setIcon(icon2);
...
" border-style: solid;"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/new/Air/Air/High_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon3.addFile(QStringLiteral(":/new/Air/Air/High_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon3.addFile(QStringLiteral(":/new/Air/Air/High_OFF.png"), QSize(), QIcon::Disabled, QIcon::On);
        Fan_High->setIcon(icon3);
...
""));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_OFF.png"), QSize(), QIcon::Disabled, QIcon::On);
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_OFF.png"), QSize(), QIcon::Active, QIcon::Off);
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_ON.png"), QSize(), QIcon::Active, QIcon::On);
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_OFF.png"), QSize(), QIcon::Selected, QIcon::Off);
        icon4.addFile(QStringLiteral(":/new/Air/Air/Dry_ON.png"), QSize(), QIcon::Selected, QIcon::On);
        Dry->setIcon(icon4);
...
""));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_OFF.png"), QSize(), QIcon::Disabled, QIcon::On);
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_OFF.png"), QSize(), QIcon::Active, QIcon::Off);
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_ON.png"), QSize(), QIcon::Active, QIcon::On);
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_OFF.png"), QSize(), QIcon::Selected, QIcon::Off);
        icon5.addFile(QStringLiteral(":/new/Air/Air/Cold_ON.png"), QSize(), QIcon::Selected, QIcon::On);
        Cold->setIcon(icon5);
...
""));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/new/Air/Air/Fan_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon6.addFile(QStringLiteral(":/new/Air/Air/Fan_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon6.addFile(QStringLiteral(":/new/Air/Air/Fan_OFF.png"), QSize(), QIcon::Disabled, QIcon::On);
        Fan->setIcon(icon6);
...
""));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/new/Air/Air/Heat_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon7.addFile(QStringLiteral(":/new/Air/Air/Heat_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        icon7.addFile(QStringLiteral(":/new/Air/Air/Heat_OFF.png"), QSize(), QIcon::Disabled, QIcon::On);
        icon7.addFile(QStringLiteral(":/new/Air/Air/Heat_OFF.png"), QSize(), QIcon::Selected, QIcon::Off);
        icon7.addFile(QStringLiteral(":/new/Air/Air/Heat_ON.png"), QSize(), QIcon::Selected, QIcon::On);
        Heat->setIcon(icon7);
...
"border-radius:25px;"));
    ...
    void retranslateUi(QDialog *AirSystem)
    {
        ...
        BackMain->setText(QApplication::translate("AirSystem", "s", nullptr));
