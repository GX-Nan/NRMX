...
"}"));
        ...
        ChandChoice->setGeometry(QRect(490, 10, 51, 41));
        QFont font3;
...
"}"));
        ...
        ChandelierSwitch2 = new QPushButton(ChandelierFrame1);
...
"}"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/Air/Air/AirSwitch.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon3.addFile(QString::fromUtf8(":/new/Air/Air/AirSwitch-ON.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        ChandeBottom_2 = new QWidget(ChandelierFrame1);
...
"}"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/new/Curtain/Curtain/Up_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon4.addFile(QString::fromUtf8(":/new/Curtain/Curtain/Up_ON.png"), QSize(), QIcon::Normal, QIcon::On);
...
"}"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/Curtain/Curtain/Down_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon5.addFile(QString::fromUtf8(":/new/Curtain/Curtain/Down_ON.png"), QSize(), QIcon::Normal, QIcon::On);
...
"}"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/Curtain/Curtain/Stop_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon6.addFile(QString::fromUtf8(":/new/Curtain/Curtain/Stop_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        ChandeBottom = new QWidget(ChandelierFrame2);
...
"}"));
        ...
        ChandelierSwitch1 = new QPushButton(ChandelierFrame2);
...
"}"));
    ...
    void retranslateUi(QDialog *LightSystem)
    {
        ...
        SelectedLed->setText(QCoreApplication::translate("LightSystem", "1", nullptr));
        ...
        label_11->setText(QCoreApplication::translate("LightSystem", "\345\220\212\347\201\257--0", nullptr));
