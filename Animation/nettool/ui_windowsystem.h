...
"}"));
        QIcon icon;
        icon.addFile(QStringLiteral(":/new/Curtain/Curtain/Down_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QStringLiteral(":/new/Curtain/Curtain/Down_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        WindowClose->setIcon(icon);
...
"}"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/new/Curtain/Curtain/Up_OFF.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon2.addFile(QStringLiteral(":/new/Curtain/Curtain/Up_ON.png"), QSize(), QIcon::Normal, QIcon::On);
        WindowOpen->setIcon(icon2);
    ...
    void retranslateUi(QDialog *WindowSystem)
    {
        ...
        BackMain->setText(QApplication::translate("WindowSystem", "s", nullptr));
