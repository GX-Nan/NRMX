...
"}"));
        ...
        HighMode->setObjectName(QStringLiteral("HighMode"));
        HighMode->setGeometry(QRect(20, 350, 181, 81));
        HighMode->setFont(font1);
        HighMode->setStyleSheet(QLatin1String("QPushButton\n"
"{\n"
"	border-radius:15px;\n"
"	background:#FFFFFF;\n"
"}"));
...
" border-style: solid;"));
    ...
    void retranslateUi(QDialog *WindSystem)
    {
        ...
        pushButton_2->setText(QApplication::translate("WindSystem", "s", nullptr));
