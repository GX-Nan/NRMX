...
/*配置模组自身的无线热点*/
#define ESP_WIFI_AP_SSID       "Spider1542"  //设置模块发出的无线名称
#define ESP_WIFI_AP_PASS       "12356789"    //无线密码
#define ESP_WIFI_AP_CHANNEL    3            //信道(默认1)
...
// #define ESP_WIFI_STA_SSID       "Alumer"  //设置模块连接的无线名称
// #define ESP_WIFI_STA_PASS       "86361137"    //无线密码
