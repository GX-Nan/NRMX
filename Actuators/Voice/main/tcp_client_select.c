...
static int Last = 1; //初始化 窗帘码数----最好写道nvs里面
...
void GPIO_init()
{
    ...
    gpio_config_t io_conf = {
        .pin_bit_mask = (1ull << 4) | (1ull << 15) | (1ull << 2) | (1ull << 25) | (1ull << 32) | (1ull << 33) | (1ull << 18) | (1ull << 19) | (1ull << 21) | (1ull << 22) | (1ull << 23),
...
void tcp_client_select_task(void *arg)
{
    ...
    char substr[11];
    char TopNumber[11];
    char Remote_Control[11];
    char Remote_Number[11];
    char Remote_Data[11];
    char Sub[2];
    char Main[2];
    int New, Step_Run;
